class NeonovaAdminView extends BaseNeonovaView {
    ...
    #renderContent() {
        ...
        const formatted = NeonovaAdminManagerView.formatForDisplay(admin.phoneNumber);
    ...
    #attachListeners() {
        ...
        if (field === 'name') {
            ...
            const current = NeonovaAdminManagerView.formatForDisplay(this.#controller.model.phoneNumber);
            cell.outerHTML = `
                <input type="text"
            ...
            input?.addEventListener('input', () => {
                const digits = NeonovaAdminManagerView.extractDigits(input.value);
                input.value = NeonovaAdminManagerView.formatForDisplay(digits);
